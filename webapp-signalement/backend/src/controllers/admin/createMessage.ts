...
export default async function createMessageAdmin(req:AuthRequest, res : Response) {
    try{
        ...
        // await createLog(userId, idSignalement , "create message admin", chiffrement(`create message par ${userId} sur signalement ${idSignalement}, message : ${bodymessage}`), ip) cassé a coriger

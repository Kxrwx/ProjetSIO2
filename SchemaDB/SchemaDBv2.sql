...
CREATE TABLE `signalements` (
  ...
  `victim_name_encrypted` varchar(50),
  `victim_contact_encrypted` varchar(100),
  `description_encrypted` text NOT NULL,
  `lieu_encrypted` varchar(60),
...
ALTER TABLE `pieces_jointes` ADD FOREIGN KEY (`signalement_id`) REFERENCES `signalements` (`id_signalement`);

ALTER TABLE `messages` ADD FOREIGN KEY (`signalement_id`) REFERENCES `signalements` (`id_signalement`);

ALTER TABLE `messages` ADD FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

ALTER TABLE `audit_logs` ADD FOREIGN KEY (`signalement_id`) REFERENCES `signalements` (`id_signalement`);

ALTER TABLE `audit_logs` ADD FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

ALTER TABLE `ia_classifications` ADD FOREIGN KEY (`signalement_id`) REFERENCES `signalements` (`id_signalement`);
